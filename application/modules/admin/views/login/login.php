...
<html class="bg-black">
    ...
    <!-- Morris chart -->
    <link href="<?php echo site_url('assets/css/morris/morris.css')?>" rel="stylesheet" type="text/css" />
	<link href="<?php echo site_url('assets/css/pickmeup.min.css')?>" rel="stylesheet" type="text/css" />
        ...
        <div class="form-box" id="login-box">
            ...
            <form action="<?php echo site_url('admin/login/login')?>" method="post">
                ...
                <div class="footer">
					...
					<span class="pull-right"><a href="<?php echo site_url('admin/register')?>"><?php echo lang('register')?></a></span>
