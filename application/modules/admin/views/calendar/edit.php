...
<link href="<?php echo site_url('assets/wd/')?>/css/colorselect.css" rel="stylesheet" />   
<script src="<?php echo site_url('assets/wd/js/')?>/jquery.colorselect.js" type="text/javascript"></script>   
<script src="<?php echo site_url('assets/wd/js/')?>/jquery.validate.js" type="text/javascript"></script>     
...
<script src="<?php echo site_url('assets/wd/js/')?>/jquery.dropdown.js" type="text/javascript"></script>     
