                        ...
                        <div class="col-md-12">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="<?php echo ($tab=="medication_history")?'active':'';?> hide"><a href="#tab_2" data-toggle="tab" aria-expanded="false">Medication History</a></li>
									 <li class="<?php echo ($tab=="payment_history")?'active':'';?>"><a href="#tab_3" data-toggle="tab" aria-expanded="false">Payment History</a></li>
									  <li class="<?php echo ($tab=="appointment")?'active':'';?> hide"><a href="#tab_4" data-toggle="tab" aria-expanded="false">Appointments</a></li>
                            ...
                            <div class="box-body">
                               ...
                               <div class="box-header ">
								...
								<div class="pull-right">
								 <a class="btn btn-primary"  style="color:#FFFFFF" href="#edit_patient<?php echo $patient->id; ?>" data-toggle="modal"><i class="fa fa-edit"></i> <?php echo lang('edit')?></a>
								 	
                                  <a class="btn btn-danger"  style="color:#FFFFFF" href="<?php echo site_url('admin/patients/delete/'.$patient->id); ?>" onclick="return confirm('If you delete this patient all information related to this, e.g. invoices, prescriptions etc. will also be deleted permanently')" ><i class="fa fa-trash"></i> <?php echo lang('delete')?></a>
								  </div>
								 </div>
							    ...
							    <table class="table table-bordered table-striped dataTable" >
									<tr>
										...
										<td><?php echo date_convert($patient->add_date);?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><?php echo date_convert($patient->birthday_date)?></td>
									</tr>
									<tr class="hide">
										<th>Age</th>
                        ...
                        <tbody>
                            <?php $i=1;foreach ($prescriptions as $new){?>
                                <tr class="gc_row">
                                    ...
                                    <td><?php echo date_convert($new->date_time);?></td>
                        		    <td width="45%">
                    ...
                    <a class="btn btn-default" href="#add_inv" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo lang('add') ." ". lang('payment');?></a>
                        ...
                        <?php if(isset($appointments)):?>
							...
							?>
                                <tr class="gc_row">
									<td style="display:none"></td>
                                   <td><?php echo date_time_convert($new->date)?></td>
                        ...
                        <tbody>
							...
							?>
                                <tr class="gc_row">
                                    <td><?php echo date_time_convert($prescription->date_time)?></td>
												...
												<div class="row">
													<div class="col-md-12">
														...
														<select name="doctor_id" class="form-control doctor_id" required>
															<option value="">--<?php echo lang('select')." ".lang('doctor'); ?>
                        ...
                        <tbody>
                            <?php $i=1;foreach ($notes as $new){?>
                                <tr class="gc_row">
                                    <td><?php echo $i?></td>
                                    <td><?php echo date_time_convert($new->datetime);?></td>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="icontainer ">	
																	...
																	?>
														<div class="col-md-3">	
																	<div class="col-md-12 "><small class="badge pull-right bg-red"><a href="#" style="color:#FFF" class="delimage" id="<?php echo $new->id?>" ><i class="fa fa-close"></i></a></small></div>		
																	<div class="gallery" >
																	<a href="<?php echo base_url('uploads/wysiwyg/images/'.$new->file_name)?>">
																		
																		<img src="<?php echo base_url('uploads/wysiwyg/thumbnails/'.$new->file_name)?>" alt="" title="<?php echo $new->title?>"  width="205" height="155" />
			...
			<input type="hidden" name="id" value="<?php echo $payment->id;?>" />
					  ...
					  <div class="form-group" style="margin-top:20px;">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <input type="text" name="payment_for" value="<?php echo $payment->payment_for;?>" class="form-control payment_for" />
						...
						<?php /*?><div class="form-group" style="margin-top:20px;">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <input type="text" name="balance" value="<?php echo $payment->balance ?>" id="balance" class="form-control balance" />
					  ...
					  <div class="form-group" style="margin-top:20px;">
						...
						<?php /*?><div class="form-group" style="margin-top:20px;">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <input type="text" name="balance" value="" id="balance" class="form-control balance" />
           		    ...
           		    <div class="box-body">
						 ...
						 <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
									<?php echo date_time_convert($app->date); ?>
                                </div>
                            </div>
                        </div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<select name="doctor_id" class="form-control doctor_id" required>
										<option value="">--<?php echo lang('select')." ".lang('doctor'); ?>
										<?php foreach($doctors as $doc){?>
											<option value="<?php echo $doc->id?>" <?php echo ($doc->id==$list->doctor_id)?'selected="selected"':'' ?>><?php echo $doc->name?></option>
										<?php }?>	
									</select>
								</div>
							</div>
									...
									<table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
										...
										<img src="<?php echo site_url('assets/img/doctor_logo.png/')?>"  height="70" width="80" />
											...
											<td align="right">
												...
												<b>Payment Date:</b> <?php echo date_convert($details->date);?><br />
												<b><?php echo lang('payment_mode') ?>:</b> <?php echo $details->mode ?><br/>
												<b>Issue Date:</b> <?php echo date_convert('Y-m-d')?><br />
								...
								<td>
									<table  width="100%" style="border:1px solid #CCCCCC;" >
										...
										<tr >
											 ...
											 <td width="75%" style="border-right:1px solid #CCCCCC"><?php echo $details->payment_for?></td>
							...
							<td >
								<table width="100%">
									<tr>
										...
										<td ><b><?php echo lang('date')?></b> : <?php echo date_convert($prescription->date_time)?></td>
									</tr>
								</table>	
							</td>
						</tr>
                       ...
                       <input type="hidden" name="id" value="<?php echo $patient->id; ?>" />
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-8">
                                    <label for="contact" style="clear:both;">DOB</label>
									<input type="text" name="birthday_date" value="<?php echo $patient->birthday_date?>" class="form-control birthday_date datepicker1">
                                </div>
                            </div>
                        </div>	
...
//$(this).closest("form").submit();	
	...
	$.ajax({
		...
		type:'POST',
		data:{patient_id:patient_id,notes:notes,doctor_id:doctor_id},
...
$( "#add_inv_form" ).submit(function( event ) {
	...
	$.ajax({
		...
		type:'POST',
		data:{patient_id:patient_id,invoice_no:invoice_no,amount:amount,payment_mode_id:payment_mode_id,date:date,payment_for:payment_for,balance:balance,doctor_id:doctor_id},
		success:function(result){
			  if(result==1)
				{
					//alert("value=0");
...
$( "#add_note" ).submit(function( event ) {
	...
	notes = $('.notes').val();
	//doctor_id = $(form ).find('input[name=doctor_id]').val();
	//alert(doctor_id);
	call_loader_ajax();	
	$.ajax({
...
function call_loader(){
	...
	if($('#overlay').length == 0 ){
		var over = '<div id="overlay">' +
						'<img  style="padding-top:300px; padding-left:500px;"id="loading" src="<?php echo site_url('assets/img/green-ajax-loader.gif')?>"></div>';
...
$(".delimage").on('click',function() {   
   ...
   if(confirm('Do You Want To Remove This Image')){
		 ...
		 if(val){
			call_loader();
			$.ajax({
			url: '<?php echo site_url('admin/patients/delete_image') ?>',
			type:'POST',
			data:{image_id:val,id:id},
			success:function(result){
			  if(result==1){
				 $("#overlay").remove();
				 window.location = "<?php echo site_url('admin/patients/view/'.$patient->id.'/images')?>";
