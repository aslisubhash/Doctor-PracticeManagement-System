...
<?php  } ?>
            ...
            <div class="col-xs-12">
                <div class="btn-group pull-right">
					...
					<a class="btn btn-success" href="#import" data-toggle="modal" style="margin-left:4px"><i class="fa fa-upload"></i> <?php echo lang('import')?> </a>
                </div>
            </div>    
        </div>	
				...
				<form method="post">
						...
						<div class="col-xs-5">
							<select name="filter_id" class="form-control" >
								...
								<option value="contact" <?php echo (@$_POST['filter_id']=="contact")?'selected="selected"':'';?>>Telephone Number</option>
                        ...
                        <tbody style="cursor:pointer">
                            <?php $i=1;foreach ($patients as $new){?>
                                <tr class="gc_row">
									...
									<td id="<?php echo $new->id?>"><?php echo date_convert(($new->birthday_date)) ?></td>
									<td id="<?php echo $new->id?>"><?php echo $new->contact ?></td>
									<td id="<?php echo $new->id?>"><?php echo $new->email ?></td>
									<td id="<?php echo $new->id?>"><?php echo date_convert($new->add_date) ?></td>
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-6">
									...
									<input type="text" name="birthday_date" value="<?php echo set_value('birthday_date')?>" class="form-control birthday_date datepicker">
                                </div>
                            </div>
                        </div>	
						 <div class="form-group">
...
<div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
			
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="addlabel"><?php echo lang('import');?> <?php echo lang('patient')?></h4>
      </div>
      <div class="modal-body">
	   <div id="err">  
		<?php 
		...
		<?php  } ?>  
					...
					<form method="post" action="<?php echo site_url('admin/patients/import/')?>" id="import_form" enctype="multipart/form-data">
                    <div class="box-body">
						<h6 style="color:#FF0000">Add Custom Field In Excel File From F1,G1,H1,I1... and Values F2,G2,H2,I2..</h6>
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-6">
                                    <label for="name" style="clear:both;">Excel File</label>
						...
						<a href="<?php echo base_url('assets/patients.xls') ?>" download class="btn btn-default" > <i class="fa fa-download"></i> Download Sample File</a>
...
<?php /*?><script src="<?php echo base_url('assets/js/plugins/datatables/jquery.dataTables.js')?>" type="text/javascript"></script><?php */?>
<script src="<?php echo base_url('assets/js/plugins/datatable_new/js/jquery.dataTables.min.js')?>"></script>
