                        ...
                        <tbody>
							...
							?>
                                <tr class="gc_row">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                         <a class="btn btn-primary" style="margin-left:5px;" href="<?php echo site_url('admin/custom_fields/edit/'.$new->id); ?>"><i class="fa fa-edit"></i> <?php echo lang('edit');?></a>
                                         <a class="btn btn-danger" style="margin-left:5px;" href="<?php echo site_url('admin/custom_fields/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $i++;}?>
