									...
									<table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
										...
										<img src="<?php echo site_url('assets/img/doctor_logo.png/')?>"  height="70" width="80" />
											...
											<td align="right">
												...
												<b>Issue Date:</b> <?php echo date_convert(date('Y-m-d'))?><br />
						...
						<?php /*?><div class="form-group" style="margin-top:20px;">
						  ...
						  <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <input type="text" name="date" value="<?php echo date('d/m/Y', strtotime($payment->date)); ?>" class="form-control datepicker date" />
                                </div>
                            </div>
                        </div>
